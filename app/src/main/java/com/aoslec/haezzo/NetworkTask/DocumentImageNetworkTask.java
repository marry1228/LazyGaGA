...
public class DocumentImageNetworkTask extends AsyncTask<Integer, String, Integer> {
    ...
    public DocumentImageNetworkTask(Context context, String mAddr, String devicePath, ImageView imageView) {
